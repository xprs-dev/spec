...
| Section 6.2.1, redacted packets (`xr:`) | **specified, not implemented**; the sealed-body `x:` machinery is live, the partial-redaction profile is not, no composer parses `((...))` and nothing derives the slow key yet |
